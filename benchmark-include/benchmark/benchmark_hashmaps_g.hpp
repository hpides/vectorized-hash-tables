...
/* READ BENCHMARK HASHMAPS G */
/* Hash maps for dense key/hash function benchmarks */
...
uint64_t get_num_hashmaps_g() {
#define BASIC_READ_BENCHMARK_HASHMAPS                                                                                                          \
  hashmaps::UnalignedLinearProbingAoSHashTable<KeyT, ValueT, MultShift64Hasher, false, utils::PrefetchingLocality::NO, true>,                  \
      hashmaps::StoringRobinHoodAoSHashTable<KeyT, ValueT, MultShift64Hasher, false, utils::PrefetchingLocality::NO, true>,                    \
      hashmaps::UnalignedRecalculatingRobinHoodAoSHashTable<KeyT, ValueT, MultShift64Hasher, false, utils::PrefetchingLocality::NO, true>,     \
      hashmaps::LinearProbingPackedSoAHashTable<KeyT, ValueT, MultShift64Hasher, true>,                                                        \
      ...
      hashmaps::ChainedHashTable<KeyT, ValueT, MultShift64Hasher, true, hashmap::hashmaps::MemoryBudget::KeyValue, 10, true>,                  \
      hashmaps::ChainedHashTable<KeyT, ValueT, MultShift64Hasher, true, hashmap::hashmaps::MemoryBudget::Bucket8FP, 10, true>,                 \
      hashmaps::ChainedHashTable<KeyT, ValueT, MultShift64Hasher, true, hashmap::hashmaps::MemoryBudget::Bucket16FP, 10, true>,                \
...
#define BASIC_SIMD_READ_BENCHMARK_HASHMAPS                                                                                                           \
  hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, 128, SIMDAlgorithm::TESTZ, false, false, NEONAlgo::SSE2NEON,    \
                                           false, false, utils::PrefetchingLocality::NO, true, true, hashing::FingerprintBucketBits::LSBMSB>,        \
      hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, 128, SIMDAlgorithm::TESTZ, false, false,                    \
                                               NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::NO, true, true,                         \
                                               hashing::FingerprintBucketBits::MSBLSB>,                                                              \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint16_t, hashmaps::KeyValueAoSStoringBucket, 8, 128, SIMDAlgorithm::TESTZ,  \
                                       false, false, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM, true, true,               \
                                       hashing::FingerprintBucketBits::MSBLSB>,                                                                      \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, hashmaps::KeyValueAoSStoringBucket, 16, 128, SIMDAlgorithm::TESTZ,  \
                                       false, false, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM, true, true,               \
                                       hashing::FingerprintBucketBits::MSBLSB>,                                                                      \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint16_t, hashmaps::KeyValueAoSStoringBucket, 8, 128, SIMDAlgorithm::TESTZ,  \
                                       false, false, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM, true, true,               \
...
#define INTERM_SIMD_READ_BENCHMARK_HASHMAPS                                                                                                          \
  hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, 256, SIMDAlgorithm::TESTZ, false, false, NEONAlgo::SSE2NEON,    \
                                           false, false, utils::PrefetchingLocality::NO, true, true, hashing::FingerprintBucketBits::LSBMSB>,        \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint16_t, hashmaps::KeyValueAoSStoringBucket, 16, 256, SIMDAlgorithm::TESTZ, \
                                       false, false, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM, true, true,               \
                                       hashing::FingerprintBucketBits::LSBMSB>,                                                                      \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, hashmaps::KeyValueAoSStoringBucket, 32, 256, SIMDAlgorithm::TESTZ,  \
                                       false, false, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM, true, true,               \
                                       hashing::FingerprintBucketBits::LSBMSB>,                                                                      \
      hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, 256, SIMDAlgorithm::TESTZ, false, false,                    \
                                               NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::NO, true, true,                         \
                                               hashing::FingerprintBucketBits::MSBLSB>,                                                              \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint16_t, hashmaps::KeyValueAoSStoringBucket, 16, 256, SIMDAlgorithm::TESTZ, \
                                       false, false, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM, true, true,               \
...
#define FULL_SIMD_READ_BENCHMARK_HASHMAPS                                                                                                            \
  hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, 512, SIMDAlgorithm::TESTZ, true, false, NEONAlgo::SSE2NEON,     \
                                           false, false, utils::PrefetchingLocality::NO, true, true, hashing::FingerprintBucketBits::LSBMSB>,        \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint16_t, hashmaps::KeyValueAoSStoringBucket, 32, 512, SIMDAlgorithm::TESTZ, \
                                       true, false, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM, true, true,                \
                                       hashing::FingerprintBucketBits::LSBMSB>,                                                                      \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, hashmaps::KeyValueAoSStoringBucket, 64, 512, SIMDAlgorithm::TESTZ,  \
                                       true, false, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM, true, true,                \
                                       hashing::FingerprintBucketBits::LSBMSB>,                                                                      \
      hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, 512, SIMDAlgorithm::TESTZ, true, false, NEONAlgo::SSE2NEON, \
                                               false, false, utils::PrefetchingLocality::NO, true, true, hashing::FingerprintBucketBits::MSBLSB>,    \
...
#define FULL_SIMD_READ_BENCHMARK_HASHMAPS                                                                                                            \
  hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, utils::sve_register_size, SIMDAlgorithm::TESTZ, false, true,    \
                                           NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::NO, true, true,                             \
                                           hashing::FingerprintBucketBits::MSBLSB>,                                                                  \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint16_t, hashmaps::KeyValueAoSStoringBucket, 32, utils::sve_register_size,  \
                                       SIMDAlgorithm::TESTZ, false, true, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM,      \
                                       true, true, hashing::FingerprintBucketBits::MSBLSB>,                                                          \
      hashmaps::BucketingSIMDHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, hashmaps::KeyValueAoSStoringBucket, 64, utils::sve_register_size,   \
                                       SIMDAlgorithm::TESTZ, false, true, NEONAlgo::SSE2NEON, false, false, utils::PrefetchingLocality::MEDIUM,      \
                                       true, true, hashing::FingerprintBucketBits::MSBLSB>,                                                          \
      hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, MultShift64Hasher, uint8_t, utils::sve_register_size, SIMDAlgorithm::TESTZ, false,      \
...
#define BENCHMARK_HASHMAPS_G FULL_SIMD_READ_BENCHMARK_HASHMAPS, EXTERNAL_READ_BENCHMARK_HASHMAPS
