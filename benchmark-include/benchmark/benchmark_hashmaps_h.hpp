...
// Hashmaps for pointer values/large struct (just what we show in the plot)

namespace benchmark {

uint64_t get_num_hashmaps_h() {
...
#define BASIC_SIMD_READ_BENCHMARK_HASHMAPS                                                                                                           \
  hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, DefaultHasher, uint8_t, 128, SIMDAlgorithm::TESTZ, false, false, NEONAlgo::SSE2NEON, false, \
                                           false, utils::PrefetchingLocality::NO, true, true, hashing::FingerprintBucketBits::LSBMSB>,               \
...
#define FULL_SIMD_READ_BENCHMARK_HASHMAPS                                                                                                           \
  hashmaps::FingerprintingSIMDSoAHashTable<KeyT, ValueT, DefaultHasher, uint8_t, 512, SIMDAlgorithm::TESTZ, true, false, NEONAlgo::SSE2NEON, false, \
                                           false, utils::PrefetchingLocality::NO, true, true, hashing::FingerprintBucketBits::LSBMSB>,              \
...
#define BENCHMARK_HASHMAPS_H FULL_SIMD_READ_BENCHMARK_HASHMAPS, EXTERNAL_READ_BENCHMARK_HASHMAPS
