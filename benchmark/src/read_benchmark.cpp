...
void ReadBenchmarkResultCollector::to_csv(std::filesystem::path path) {
  ...
  for (const ReadBenchmarkResult& result : benchmark_results_) {
    result_file << fmt::format("{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}",
                               ...
                               result.distribution_name, result.workload, result.key_size, result.value_size,
                               result.entry_size, result.entries_processed, result.runtime, result.thread_avg_runtime, result.thread_max_runtime,
                               result.zipf, result.zipf_factor, result.successful)
                << std::endl;
  }
